...
venue: "Good Practices for scientific software development using High Performance Computing (HPC) in the cloud" # brief name of host site without address (e.g., "Euphoric State University")
