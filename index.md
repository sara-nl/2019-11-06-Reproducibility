...
venue: "Making your Research Reproducible" # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Nov 6-7, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Faruk Diblen (eScience Center), Lykle Voort (SURFsara)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Carlos Martínez (eScience Center), Sagar Dolas (SURFsara)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
